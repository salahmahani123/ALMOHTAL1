...
gg.isPackageInstalled("com.gg.new.almohtal.gfh"or"com.tencent.igxv.misVenom") 
First=gg.isPackageInstalled("com.tencent.igxv.misVenom") or gg.isPackageInstalled("com.gg.new.almohtal.gfh")
if First==false then
 gg.alert("📛عليك تثبيت الجيم جاردن الخاص ب القناتين📛") 
gg.alert("👑MR VENOM \nALMOHTAL👑")
...
if gg.getTargetPackage() == "com.tencent.ig" or gg.getTargetPackage() == "com.rekoo.pubgm" or gg.getTargetPackage() == "com.tencent.tmgp.pubgmhd" or gg.getTargetPackage() == "com.pubg.krmobile" or gg.getTargetPackage() == "com.vng.pubgmobile" or gg.getTargetPackage() == "com.gg.new.almohtal.gfh" or gg.getTargetPackage() ==
"com.tencent.iglite" then
    gg.clearResults()
  else
...
os.remove("/data/data/com.rekoo.pubgm/code_cache")
gg.sleep(10000)
  gg.toast("جاري حذف ملفات الباند")
end
function anti2()
gg.remove("/storage/emulated/0/Android/data/com.tencent.ig/cache")
  ...
  gg.remove("/storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Pando")
  gg.remove("/storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Puffe")
...
function mw6()
  Sdikksable5 = gg.alert("cantDec", "⟬BACK⟭", "⟬NEXT⟭")
