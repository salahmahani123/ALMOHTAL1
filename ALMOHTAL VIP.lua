...
gg.clearResults()
gg.setRanges(4)
gg.searchNumber("257;2131;-10F~888888F;0::50", 4, false, 536870912, 0, -1)
gg.searchNumber("-10F~888888F", 16, false, 536870912, 0, -1)
gg.getResults(10)
gg.editAll("0", 16)
gg.clearResults()
gg.setRanges(4)
...
gg.clearResults()
gg.setRanges(16384)
gg.searchNumber("-1.3068388e21;-9.3858979e22", 16, false, 536870912, 0, -1)
gg.searchNumber("-9.3858979e22", 16, false, 536870912, 0, -1)
gg.getResults(100)
gg.editAll("-5112e21", 16)
gg.clearResults()
gg.setRanges(4)
gg.searchNumber("1.4349296e-41;1.4012985e-45;5.6051939e-45;2.986167e-42::", 16)
gg.getResults(999)
gg.editAll("0", 16)
gg.clearResults()
gg.setRanges(4)
gg.searchNumber("2.986167e-42", 16)
gg.getResults(999)
gg.editAll("0", 16)
gg.clearResults()
gg.setRanges(32)
...
function wh4()
  FIXBLINK11 = gg.multiChoice({
    "✧ Wallhack Fix Blink [All Device]",
    "✧ Wallhack Fix Blink [430-835]",
    "✧ Wallhack Fix Blink [845-855]",
    "⎋رجوع"
  }, nil, "🇪🇬 Script ALMOHTAL GAMER V11.0 🇪🇬\n🇪🇬 Youtube Channel: ALMOHTAL GAMER 🇪🇬\n🇪🇬 Telegram: @ALMOHTAL1 🇪🇬")
...
gg.setRanges(gg.REGION_ANONYMOUS)
  ...
  gg.getResults(20)
  gg.editAll("9999", gg.TYPE_FLOAT)
  gg.toast("☬ Wallhack Fix Blink 430-835 ☬")
end
function fxajhd3()
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
...
function wc2()
  FIXBLINKg11 = gg.multiChoice({
    "✧ Wallhack Fix Blink [All Device]",
    "✧ Wallhack Fix Blink [430-835]",
    "✧ Wallhack Fix Blink [845-855]",
    "⎋رجوع"
  }, nil, "🇪🇬 Script ALMOHTAL GAMER V11.0 🇪🇬\n🇪🇬 Youtube Channel: ALMOHTAL GAMER 🇪🇬\n🇪🇬 Telegram: @ALMOHTAL1 🇪🇬")
  if FIXBLINKg11 == nil then
  else
    if FIXBLINKg11[1] == true then
      fxajhwend1()
    end
    if FIXBLINKg11[2] == true then
      fxajhwend2()
    end
    if FIXBLINKg11[3] == true then
      fxajhwend3()
    end
    if FIXBLINKg11[4] == true then
      CHIPSET()
    end
  end
  ANDOUKA1 = -1
...
function wc17()
  ...
  gg.addListItems((gg.getResults(100, nil, nil, nil, nil, nil, nil, nil, nil)))
  gg.toast("☬ Wallhack Kirin 710 PROCESSING ☬")
end
function wc18()
  gg.clearList()
  gg.setRanges(gg.REGION_C_ALLOC)
...
function crhk1()
  CHACK1 = gg.multiChoice({
    ...
    "✧ Color 425 Yellow",
    "✧ New Color 615 Green",
    "✧ New Color 615 Yellow",
    "✧ New Color 660 Green",
    "✧ New Color 660 Red",
    "✧ New Color 660 Yellow",
    "✧ New Color 675 Yellow",
    "✧ New Color 710 Blue",
    "✧ New Color 710 Gren",
    "✧ New Color 710 Red",
    "✧ Color 835 Red",
...
function cr3()
  YLOWCLOR1 = gg.multiChoice({
    "✧ Color Yellow V1 [Full Colour]",
    "✧ Color Yellow V2 [Only Body]",
    "✧ Color Yellow V3 [Only Body]",
    "⎋رجوع"
  }, nil, "🇪🇬 Script ALMOHTAL GAMER V11.0 🇪🇬\n🇪🇬 Youtube Channel: ALMOHTAL GAMER 🇪🇬\n🇪🇬 Telegram: @ALMOHTAL1 🇪🇬")
...
function crhk4()
  CHACK44 = gg.multiChoice({
    ...
    "✧ New Color Mediatek Red",
    "✧ New Color Mediatek Yellow",
    "✧ New Color Mediatek White",
    "✧ Color Mediatek P22 Green",
    "✧ New Color Mediatek P22 Yellow",
...
function MENUWEAPON153()
  MENUWEAPON11 = gg.multiChoice({
    "✧ ايم بوت  100م [لوبي]",
    "✧ايم بوت خارق  [جيم]",
    "✧قفل الايم علي للعدو  [جيم]",
    "✧ تثبيت سلاح على العدو [جيم]",
    "✧ إيقاف إهتزاز سلاح [جيم]",
    "✧ هيدشوت   [لوبي]",
    "✧ إقفل المشاهدات [في ساحة الانتظار]",
    "✧ جديد إيقاف دمج جميع اسلاحه [جيم]",
    "✧ زيادة دماج [جيم]",
    "✧ ثبث سلاح جديد 50%[لوبي]",
    "✧ ماجيك بوليت  [جيم]",
    "✧ تبث سلاح [جيم]",
    "✧ جديد تبث سلاح 100%[لوبي]",
    "✧ تثبيت الشوتجان  [جيم]",
    "✧ تسريع طلق سلاح [جيم]",
    "✧ قتل من وراء الجدران [جيم]",
    "⎋رجوع"
  }, nil, "🇪🇬 Script ALMOHTAL GAMER V11.0 🇪🇬\n🇪🇬 Youtube Channel: ALMOHTAL GAMER 🇪🇬\n🇪🇬 Telegram: @ALMOHTAL1 🇪🇬")
...
gg.refineAddress("FC", -1, 16, 536870912, 0, -1)
gg.getResults(1)
gg.editAll("250", 16)
gg.clearResults()
gg.searchNumber("250;30.5", 16, false, 536870912, 0, -1)
gg.refineAddress("00", -1, 16, 536870912, 0, -1)
gg.getResults(1)
gg.editAll("305", 16)
gg.clearResults()
...
gg.refineAddress("2A0", -1, 32, 536870912, 0, -1)
gg.refineNumber("-1903895931231645695", 32, false, 536870912, 0, -1)
gg.getResults(1401)
...
function MENUWEAPON()
  MENUWEAPON1 = gg.multiChoice({
    "✧ أنتينا لاعب [لوبي/جيم]",
    "✧ تشغيل ESP ألاعب [جيم]",
    "✧ باراشوت سريع [ساحة الانتضار]",
    "✧ طيارين بسيارة الجيب [جيم]",
    "✧ عدو كبير [جيم]",
    "✧ قفزه عاليه بدون دماج [جيم]",
    "✧ قفزه متكررة [جيم]",
    "✧ قفزه طويله [جيم]",
    "✧ إيقاف الخطوات [جيم]",
    "✧ يد طويلة [جيم]",
    "✧ الجلوس و فتح سكوب [جيم]",
    "✧ الجلوس عرضة [جيم]",
    "✧ الجلوس و الوقوف فتح سكوب [جيم]",
    "✧ التقاطع الصغيرة [لوبي]",
    "✧ تسريع جميع سيارات [جيم]",
    "✧ نوك لاعب سريع [جيم]",
    "✧ تسريع لاعب [جيم]",
    "✧ تسريع لاعب بدون لاق [جيم]",
    "✧ مشاهدة واسعة [جيم]",
    "✧ تكبير سكوب [جيم]",
    "⎋رجوع"
  }, nil, "🇪🇬 Script ALMOHTAL GAMER V11.0 🇪🇬\n🇪🇬 Youtube Channel: ALMOHTAL GAMER 🇪🇬\n🇪🇬 Telegram: @ALMOHTAL1 🇪🇬")
...
function wp1()
  ANTENAHC1 = gg.multiChoice({
    "✧ انتينا ألاعب [لوبي]",
    "✧ أنتينا رصاص 5.56mm [جيم]",
    "✧ أنتينا الصندوق [جيم]",
    "✧ أنينا VMOS [جيم]",
    "✧ أنتينا فلير جان [جيم]",
    "✧ أنتينا Items Level 3 [جيم]",
    "✧ أنتينا M416/Scar-L [جيم]",
    "✧ أنتينا Scope 6x/8x [جيم]",
    "✧ أنتينا Stand [جيم]",
    "⎋رجوع"
  }, nil, "🇪🇬 Script ALMOHTAL GAMER V11.0 🇪🇬\n🇪🇬 Youtube Channel: ALMOHTAL GAMER 🇪🇬\n🇪🇬 Telegram: @ALMOHTAL1 🇪🇬")
...
function atnh4()
  KLIKatnh4 = gg.alert("☬ Activated Every 15 Minutes ☬", "⟬رجوع⟭", "⟬NEXT⟭")
  if KLIKatnh4 == 1 then
    wp1()
  end
  if KLIK == 2 then
...
function wp12()
  ...
  gg.refineNumber("18.38614463806;0.53446578979", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  gg.getResults(100)
  gg.editAll("240", gg.TYPE_FLOAT)
  gg.clearResults()
...
function MENUVISUAL()
  MENUVISUAL1 = gg.multiChoice({
    ...
    "✧ إزالة ضباب [جيم]",
    "✧ سماء حمراء 425 [جيم]",
    "✧ منظور الثلج في ميرامار [جيم]",
    "✧ إزالة العشب + أشجار Exynos [جيم]",
    "✧ إزالة أشجار + العشب Snapdragon[جيم]",
    "⎋رجوع"
  }, nil, "🇪🇬 Script ALMOHTAL GAMER V11.0 🇪🇬\n🇪🇬 Youtube Channel: ALMOHTAL GAMER 🇪🇬\n🇪🇬 Telegram: @ALMOHTAL1 🇪🇬")
